...
namespace ServiceLayer.Code
{
    public class EmployeeService : IEmployeeService
    {
        ...
        public dynamic GetBillDetailForEmployeeService(FilterModel filterModel)
        {
            ...
            List<Organization> organizations = _db.GetList<Organization>(ConfigurationDetail.sp_company_get);
        ...
        private List<Employee> FilterInActiveEmployees(FilterModel filterModel)
        {
            ...
            List<EmployeeArchiveModal> employeeArchiveModal = _db.GetList<EmployeeArchiveModal>(ConfigurationDetail.SP_Employee_GetAllInActive, new
            {
                filterModel.SearchString,
                filterModel.SortBy,
                filterModel.PageIndex,
        ...
        public List<AutoCompleteEmployees> EmployeesListDataService(FilterModel filterModel)
        {
            ...
            List<AutoCompleteEmployees> employees = _db.GetList<AutoCompleteEmployees>(ConfigurationDetail.SP_Employee_GetAll, new
            {
                filterModel.SearchString,
                filterModel.PageIndex,
                filterModel.PageSize,
        ...
        {
            var result = _db.FetchDataSet(ConfigurationDetail.sp_leave_detail_getby_employeeId, new
            {
                EmployeeId,
            });
        ...
        {
            var result = _db.FetchDataSet(ConfigurationDetail.sp_attandence_detail_by_employeeId, new
            {
                EmployeeId,
            });
        ...
        {
            var resultset = _db.GetDataSet(ConfigurationDetail.sp_manage_employee_detail_get, new
            {
                EmployeeId,
        ...
        {
            var resultset = _db.GetDataSet(ConfigurationDetail.SP_MappedClients_Get, new
            {
        ...
        public DataSet UpdateEmployeeMappedClientDetailService(EmployeeMappedClient employeeMappedClient, bool IsUpdating)
        {
            ...
            var records = _db.GetList<EmployeeMappedClient>(ConfigurationDetail.sp_employees_mappedClient_get_by_employee_id, new
            {
            ...
            var resultset = _db.GetDataSet(ConfigurationDetail.sp_employees_addupdate_remote_client, new
            {
        ...
        {
            Employee employee = _db.Get<Employee>(ConfigurationDetail.SP_Employees_ById, new { EmployeeId = EmployeeId, IsActive = IsActive });
            return employee;
        }

        public EmployeeCompleteDetailModal GetEmployeeCompleteDetail(int EmployeeId)
        {
            DataSet ds = _db.FetchDataSet(ConfigurationDetail.sp_Employee_GetCompleteDetail, new { EmployeeId = EmployeeId });
        ...
        {
            EmployeeArchiveModal employeeArcheiveDeatil = _db.Get<EmployeeArchiveModal>(ConfigurationDetail.sp_Employee_GetArcheiveCompleteDetail, new { EmployeeId = EmployeeId });
        ...
        private string DeActivateEmployee(int EmployeeId)
        {
            ...
            var result = _db.Execute<EmployeeArchiveModal>(ConfigurationDetail.sp_Employee_DeActivate, new
            {
                EmployeeId,
        ...
        private string ActivateEmployee(int EmployeeId)
        {
            ...
            var result = _db.Execute<EmployeeCompleteDetailModal>(ConfigurationDetail.sp_Employee_Activate, new
            {
        ...
        private EmployeeEmailMobileCheck GetEmployeeDetail(EmployeeCalculation employeeCalculation)
        {
            ...
            DataSet resultSet = _db.FetchDataSet(ConfigurationDetail.sp_employee_getbyid_to_reg_or_upd, new
            {
        ...
        private async Task<string> RegisterOrUpdateEmployeeDetail(EmployeeCalculation eCal, IFormFileCollection fileCollection)
        {
            ...
            try
            {
                ...
                var employeeId = _db.Execute<Employee>(ConfigurationDetail.sp_Employees_InsUpdate, new
                {
            ...
            catch
            {
                if (IsNewRegistration && eCal.employee.EmployeeId > 0)
                    _db.Execute(ConfigurationDetail.sp_employee_delete_by_EmpId, new { EmployeeId = eCal.employee.EmployeeId }, false);
        ...
        {
            var result = await _db.ExecuteAsync(ConfigurationDetail.sp_employees_create, new
            {
                employee.FirstName,
                employee.LastName,
                employee.Mobile,
        ...
        private async Task BulkRegistration(EmployeeCalculation eCal, IFormFileCollection fileCollection)
        {
            try
            {
                ...
                {
                    // create employee record
                    var result = _db.Execute(ConfigurationDetail.sp_employee_lastId, new { IsActive = true }, true);
                    if (string.IsNullOrEmpty(result.statusMessage))
        ...
        public async Task<string> GenerateOfferLetterService(EmployeeOfferLetter employeeOfferLetter)
        {
            ...
            var company = _db.Get<OrganizationDetail>(ConfigurationDetail.sp_company_getById, new { CompanyId = employeeOfferLetter.CompanyId });
        ...
        private string GetHtmlString(OrganizationDetail organization, EmployeeOfferLetter employee)
        {
            ...
            var LetterType = 1;
            var result = _db.Get<AnnexureOfferLetter>(ConfigurationDetail.sp_annexure_offer_letter_getby_lettertype, new { CompanyId = 1, LetterType });
        ...
        public async Task RegisterEmployeeByExcelService(Employee employee, UploadedPayrollData uploaded)
        {
            ...
            if (!string.IsNullOrEmpty(result))
            {
                ...
                List<EmployeeDeclaration> employeeDeclarations = new List<EmployeeDeclaration>();
                Employee emp = _db.Get<Employee>(ConfigurationDetail.sp_employee_and_declaration_get_byid, new { EmployeeId = employeeId });
