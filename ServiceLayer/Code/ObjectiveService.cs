...
namespace ServiceLayer.Code
{
    public class ObjectiveService : IObjectiveService
    {
        ...
        public dynamic ObjectiveInsertUpdateService(ObjectiveDetail objectiveDetail)
        {
            ...
            var objective = _db.Get<ObjectiveDetail>(ConfigurationDetail.sp_performance_objective_get_by_id, new { ObjectiveId = objectiveDetail.ObjectiveId });
            if (objective == null)
            ...
            var result = _db.Execute<ObjectiveDetail>(ConfigurationDetail.sp_performance_objective_insupd, objective, true);
        ...
        public dynamic GetPerformanceObjectiveService(FilterModel filterModel)
        {
            ...
            (List<ObjectiveDetail> objectiveDetails, List<EmployeeRole> empRoles) = _db.GetList<ObjectiveDetail, EmployeeRole>(ConfigurationDetail.sp_performance_objective_getby_filter, filterModel);
        ...
        public List<ObjectiveDetail> GetEmployeeObjectiveService(int designationId, int companyId, long employeeId)
        {
            ...
            (List<ObjectiveDetail> objectives, List<EmployeePerformance> empPerformance) = _db.GetList<ObjectiveDetail, EmployeePerformance>(ConfigurationDetail.sp_objective_getby_compid, new { CompanyId = companyId, EmployeeId = employeeId });
        ...
        public EmployeePerformance UpdateEmployeeObjectiveService(EmployeePerformance employeePerformance)
        {
            ...
            var existEmpPerformance = _db.Get<EmployeePerformance>(ConfigurationDetail.sp_employee_performance_getby_id, new { EmployeePerformanceId = employeePerformance.EmployeePerformanceId });
            ...
            var result = _db.Execute<EmployeePerformance>(ConfigurationDetail.sp_employee_performance_insupd, existEmpPerformance, true);
            if (string.IsNullOrEmpty(result))
